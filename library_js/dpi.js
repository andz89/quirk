...
// function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length);
// i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }
...
// var base64Header = btoa(String.fromCharCode.apply(String,
// _toConsumableArray(finalArray)));
...
// if (data[i - 4] === 9 && data[i - 3] === _P && data[i - 2] === _H && data[i - 1] === _Y &&
// data[i] === _S) {
// return i - 3;
// }
// }
